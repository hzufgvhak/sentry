...
private:
  ...
  float current_nav_x = 0.0f;
  float current_nav_y = 0.0f;
  float current_nav_z = 0.0f;
  ...
  rclcpp::Subscription<auto_aim_interfaces::msg::Send>::SharedPtr pose_state_sub_;
  ...
  void send_pose_state(const auto_aim_interfaces::msg::Send::ConstSharedPtr msg);
  auto_aim_interfaces::msg::FiredInfo last_fired_msg_;
  auto_aim_interfaces::msg::Send last_state_msg_;
  geometry_msgs::msg::Twist last_vel_msg_;
  // 互斥锁
