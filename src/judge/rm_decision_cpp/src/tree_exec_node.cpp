...
int main(int argc, char **argv)
{
  ...
  node->declare_parameter("odom_topic_name", "odom");
  node->declare_parameter<std::string>("team", "blue");
  ...
  factory.registerNodeType<rm_decision::Chase>("Chase",node,tf_buffer,tf_listener);
